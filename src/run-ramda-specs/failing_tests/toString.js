...
describe('toString', function () {
  ...
  it('returns the string representation of a String object', function () {
    ...
    assert.strictEqual(
      R.toString(new String('x "y" z')),
      'new String("x \\"y\\" z")'
    )
    assert.strictEqual(R.toString(new String("' '")), 'new String("\' \'")')
    assert.strictEqual(
      R.toString(new String('" "')),
      'new String("\\" \\"")'
    )
    assert.strictEqual(
      R.toString(new String('\b \b')),
      'new String("\\b \\b")'
    )
    assert.strictEqual(
      R.toString(new String('\f \f')),
      'new String("\\f \\f")'
    )
    assert.strictEqual(
      R.toString(new String('\n \n')),
    ...
    assert.strictEqual(
      R.toString(new String('\v \v')),
      'new String("\\v \\v")'
    )
    assert.strictEqual(
      R.toString(new String('\0 \0')),
      'new String("\\0 \\0")'
    )
    assert.strictEqual(
      R.toString(new String('\\ \\')),
  ...
  it('returns the string representation of a Date object', function () {
    assert.strictEqual(
      R.toString(new Date('2001-02-03T04:05:06.000Z')),
